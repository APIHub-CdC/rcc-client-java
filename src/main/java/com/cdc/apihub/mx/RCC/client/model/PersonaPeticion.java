...
import com.cdc.apihub.mx.RCC.client.model.CatalogoEstadoCivil;
import com.cdc.apihub.mx.RCC.client.model.CatalogoResidencia;
import com.cdc.apihub.mx.RCC.client.model.CatalogoSexo;
...
public class PersonaPeticion {
  ...
  @ApiModelProperty(example = "MX", required = true, value = "Debe contener la clave de la nacionalidad del consumidor los valores posibles son los siguientes: MX = México.")
