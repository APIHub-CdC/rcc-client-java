...
public class RCCApi {
    ...
    public ApiResponse<?> getGenericReporte(String xApiKey, String username, String password, PersonaPeticion request, String xFullReport) throws ApiException {
    ...
    public okhttp3.Call getReporteAsync( String xApiKey, String username, String password, PersonaPeticion request, String xFullReport, final ApiCallback<Respuesta> callback) throws ApiException {
        ProgressResponseBody.ProgressListener progressListener = null;
        ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
        if (callback != null) {
            progressListener = new ProgressResponseBody.ProgressListener() {
