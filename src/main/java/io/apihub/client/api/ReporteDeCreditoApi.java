...
public class ReporteDeCreditoApi {
	private ApiClient apiClient;

	public ReporteDeCreditoApi() {
		this(Configuration.getDefaultApiClient());
	}

	public ReporteDeCreditoApi(ApiClient apiClient) {
	...
	public Call getReporteCall(String xApiKey, String username, String password, PersonaPeticion body,
			Boolean xSegmentedReport, final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
	...
	private Call getReporteValidateBeforeCall(String xApiKey, String username, String password, PersonaPeticion body,
		...
		Call call = getReporteCall(xApiKey, username, password, body, xSegmentedReport, progressListener,
				progressRequestListener);
		return call;
	}

	public Respuesta getReporte(String xApiKey, String username, String password, PersonaPeticion body,
			Boolean xSegmentedReport) throws ApiException {
	...
	public ApiResponse<Respuesta> getReporteWithHttpInfo(String xApiKey, String username, String password,
			PersonaPeticion body, Boolean xSegmentedReport) throws ApiException {
